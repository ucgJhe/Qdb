...
class QlQdb(cmd.Cmd, QlDebugger):
    ...
    def __init__(
        ...
        self.rr = SnapshotManager(self.ql) if rr else None
        self.mm = setup_memory_Manager(self.ql)
        self.predictor = setup_branch_predictor(self.ql)
        self.render = setup_context_render(self.ql, self.predictor)
